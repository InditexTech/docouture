...
The entry page of this section is `prerequisites` — the natural reading order (see the naming conventions in the [README](../README.md)). The [sizing rule](../README.md#sizing-rule-one-page-or-many) applies: if prerequisites amount to a short list, fold them into the quickstart as its first section.
