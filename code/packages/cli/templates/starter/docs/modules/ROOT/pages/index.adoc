...
:description: Replace this with a one-line description of __PDOCS_TITLE__ — it feeds page metadata as well as the hero.
...
Replace this preamble with a short lead-in for __PDOCS_TITLE__ — one or two
...
Replace this `[feature-tabs]` block with __PDOCS_TITLE__'s own — each slide
...
Describe the first thing worth knowing about __PDOCS_TITLE__ here.
...
[cta]
====
Replace this with a short pitch for __PDOCS_TITLE__ — why it is worth a
reader's attention.
...
Replace this `[accordion]` block with __PDOCS_TITLE__'s own real questions —
