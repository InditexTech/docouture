...
====
[card,icon="shapes/forms-outlined"]
.xref:main:build/nodes/index.adoc[Nodes]
--
image::build/abstract-nodes.png["Abstract study of connected nodes, moss grey"]
...
--
image::build/abstract-plugins.png["Abstract study of interlocking blocks, indigo grey"]
...
[card,icon="others/fire-outlined"]
.xref:main:build/actions/index.adoc[Actions]
--
image::build/abstract-actions.png["Abstract study of radiating motion, rust"]
...
[card,icon="business/store-outlined"]
.xref:main:build/stores/index.adoc[Stores]
--
image::build/abstract-stores.png["Abstract study of stacked layers, steel blue"]
