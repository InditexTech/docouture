...
description: "How to cut a release or a prerelease on this Antora documentation site, scaffolded with Versioned (Full History) mode: pdocs version, docs/.release-version, and the pdocs-release.yml workflow. USE WHEN bumping a version, cutting a release, configuring what a release tag contains, or asking how versioning works on this site. EXAMPLES: 'cut a release', 'bump the docs version', 'what does docs/.release-version do', 'how do I release a new version of the docs'."
---

# Docs versioning (Versioned — Full History)

This site was scaffolded with `pdocs new --mode versioned`. `main` is permanently the
