...
Unsure whether something belongs here or in Reference? See [Guides vs Reference](../README.md#guides-vs-reference) in the README.
...
- **Turning the guide into reference.** Describing every available option mid-procedure buries the path; use one option, link the rest (see [Guides vs Reference](../README.md#guides-vs-reference)).
