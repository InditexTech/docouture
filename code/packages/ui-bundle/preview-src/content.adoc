...
//:page-role: -toc
:page-pagination:
:page-labels: Beta, Internal
:description: Content test page: exercises the article, TOC and pagination templates against long-form AsciiDoc.
...
[.properties%autowidth,cols="1,1,2"]
|===
