...
required (it isn't stopped automatically either — run `pdocs teardown kroki` once you're
done with it). Run `pdocs eject kroki` if you ever need to customize the container
