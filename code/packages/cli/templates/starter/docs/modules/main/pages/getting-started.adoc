...
see that workflow's own header comment for the full mechanism. To set the
version yourself, outside of a release — for local testing, say — use
`pdocs version` directly:
